...
public class TurnMissionStatus : MonoBehaviour
{
    ...
    [SerializeField] readonly string allyText = "내 턴";
    [SerializeField] readonly string  enemyText = "상대 턴";
    [SerializeField] readonly string neutralText = "중립 턴";
    [SerializeField] readonly string stealthPrefix = "라운드 ";
    ...
    void UpdateStealthLabel()
    {
        if (stealthRoundLabel)
            stealthRoundLabel.SetText($"{stealthPrefix}{GameManager.GetInstance.NoneBattleTurn.currRound}");
    }
